...
If ($EapConfig -eq $null) {

    Write-Warning "The VPN connection ""$ConnectionName"" is not configured to use EAP authentication. Exiting script."
    Exit
}
