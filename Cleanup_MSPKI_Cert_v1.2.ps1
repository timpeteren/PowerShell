...
function Remove-ExpiredCertFromDB {
 ...
 .DESCRIPTION
    You must choose one of the following 5 types
    - revoked
    - pending
    - issued
    - failed
 ...
 .PARAMETER state
    ...
    pending | issued | revoked | failed | denied
 ...
 .NOTES
    originally created by Andre Gibel - www.gibel.net -  03 November 2014
 ...
 #>
    ...
    Param (
        ...
        [ValidateSet("pending", "issued", "revoked", "failed","denied")]
        [string]$State,
